...
public class GameBoardPanel extends JPanel implements ActionListener {
    ...
    private void setResolution() {
        ...
        switch (currentScore / 10) {
            case 10:
                currentTimerResolution = 50;
                break;
            case 9:
                currentTimerResolution = 65;
                break;
            case 8:
                currentTimerResolution = 80;
                break;
            case 7:
                currentTimerResolution = 95;
                break;
            case 6:
                currentTimerResolution = 110;
                break;
            case 5:
                currentTimerResolution = 125;
                break;
            case 4:
                currentTimerResolution = 140;
                break;
            case 3:
                currentTimerResolution = 155;
                break;
            case 2:
                currentTimerResolution = 170;
                break;
            case 1:
                currentTimerResolution = 185;
                break;
            case 0:
                currentTimerResolution = 185;
                break;
